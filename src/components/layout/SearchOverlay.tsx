...
export function SearchOverlay() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center bg-ink-950/90 px-4 pt-32 backdrop-blur-sm">
      ...
      <form onSubmit={onSubmit} className="relative z-10 w-full max-w-xl">
        ...
        <input
          ...
          className="h-16 w-full border-b border-white/20 bg-transparent text-2xl font-display text-ink-50 outline-none placeholder:text-ink-600"
        />
