...
export function Footer() {
  return (
    <footer className="mt-auto border-t border-brand-300/20 bg-gradient-to-b from-ink-100 to-brand-50/40">
      <div className="mx-auto grid max-w-7xl gap-12 px-4 py-16 sm:px-6 lg:grid-cols-[1.2fr_1fr_1fr] lg:px-8">
        <div>
          ...
          <p className="text-body mt-4 max-w-sm text-sm text-ink-500">
            Tu acceso directo a la tecnología en Colombia: Confianza, Claridad y Tranquilidad.
          </p>
          <SocialLinks className="mt-8" />
        </div>
        <nav>
          <p className="text-meta text-[11px] uppercase tracking-[0.14em] text-ink-400">Links rápidos</p>
        ...
        <nav>
          <p className="text-meta text-[11px] uppercase tracking-[0.14em] text-ink-400">
