    ...
    <section className="pb-12 pt-8">
      <div className="mx-auto max-w-4xl px-4 sm:px-6">
        ...
        <h2 className="font-display mt-3 text-center text-3xl sm:text-4xl">
          <span className="text-gradient">Más de 300 clientes</span>{' '}
          <span className="text-ink-800">satisfechos</span>
        </h2>
        <p className="mt-3 flex items-center justify-center gap-2 text-sm text-ink-500">
          <Stars value={5} />
          <span className="text-subheading text-ink-800">4.96</span>
