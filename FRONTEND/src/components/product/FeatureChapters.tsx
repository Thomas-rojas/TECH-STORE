        ...
        return (
          <div key={chapter.title}>
            <div className="mx-auto max-w-2xl text-center">
              <p className="text-meta text-sm text-ink-400">{chapter.kicker}</p>
              <h2 className="text-heading mt-3 text-3xl text-ink-900 sm:text-5xl">
                {chapter.title}
              </h2>
              <p className="text-body mt-5 text-base text-ink-500">{chapter.body}</p>
            </div>
